    ...
    mGruppiM.forEach(function(g,mgi){
      ...
      if (g.crtCalc) {
        ...
        if (localStorage.getItem(LS_TOKEN)) {
          alert('Tariffe CRT ancora in caricamento.\nAttendi qualche secondo e riprova.');
          return;
        }
