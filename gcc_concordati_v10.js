  ...
  function _initVettoriData() {
    ...
    .then(function(gd) {
      ...
      p.then(function(rd) {
        ...
        // Carica vecchio distanziere da localStorage (formato array compatto)
        try {
            ...
            if (raw) {
              ...
              if (d && d.rows) {
                d.rows.forEach(function(r){
                  // r = [cap, prov, loc, km] (formato compatto)
