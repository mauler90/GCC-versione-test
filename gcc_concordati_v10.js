...
(function () {
  ...
  var LS_KM_VECCHIO         = 'tcp_km_vecchio';
  ...
  function _initVettoriData() {
    ...
    .then(function(gd) {
      ...
      p.then(function(rd) {
        ...
        // Carica vecchio distanziere da localStorage
        try { var _kvr=localStorage.getItem(LS_KM_VECCHIO); if(_kvr){var _kvd=JSON.parse(_kvr);if(_kvd&&_kvd.rows)_gcc_km_vecchio_rows=_kvd.rows;} } catch(e){}
