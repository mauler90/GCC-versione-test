...
(function () {
  ...
  function apriTariffarioCRT() {
    ...
    // Chiudi popup esistente se aperto sullo stesso nome
    try { var _ex = window.open('','tcp_crt'); if (_ex && !_ex.closed && _ex.document && _ex.document.body && _ex.document.body.innerHTML) { _ex.close(); } } catch(e) {}
