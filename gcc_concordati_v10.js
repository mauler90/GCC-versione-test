...
(function () {
  ...
  function _fetchGistFile(fileObj, tok) {
    ...
    // File troncato: scarica dalla raw_url
    var headers = { 'Accept': 'application/json' };
    if (tok) headers['Authorization'] = 'token ' + tok;
    return fetch(fileObj.raw_url, { headers: headers })
